...
range_state32_type = RangeType(int32, False)
range_state64_type = RangeType(int64, False)
unsigned_range_state64_type = RangeType(uint64, False)
range_state32_non0step_type = RangeType(int32, True)
range_state64_non0step_type = RangeType(int64, True)
unsigned_range_state64_non0step_type = RangeType(uint64, True)
